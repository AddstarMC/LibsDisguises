...
public enum DisguiseSound {
    ...
    PARROT(Sound.ENTITY_PARROT_HURT, Sound.ENTITY_PARROT_STEP, Sound.ENTITY_PARROT_HURT,Sound.ENTITY_PARROT_AMBIENT,
            Sound.ENTITY_PARROT_FLY, Sound.ENTITY_PARROT_EAT, Sound.ENTITY_PARROT_IMITATE_BLAZE,
            Sound.ENTITY_PARROT_IMITATE_CREEPER,Sound.ENTITY_PARROT_IMITATE_ELDER_GUARDIAN,Sound.ENTITY_PARROT_IMITATE_ENDERDRAGON,
            Sound.ENTITY_PARROT_IMITATE_ENDERMAN,Sound.ENTITY_PARROT_IMITATE_ENDERMITE,Sound.ENTITY_PARROT_IMITATE_EVOCATION_ILLAGER,
            Sound.ENTITY_PARROT_IMITATE_GHAST,Sound.ENTITY_PARROT_IMITATE_HUSK,Sound.ENTITY_PARROT_IMITATE_ILLUSION_ILLAGER,
            Sound.ENTITY_PARROT_IMITATE_MAGMACUBE,Sound.ENTITY_PARROT_IMITATE_POLAR_BEAR,Sound.ENTITY_PARROT_IMITATE_SHULKER,
            Sound.ENTITY_PARROT_IMITATE_SILVERFISH,Sound.ENTITY_PARROT_IMITATE_SKELETON,Sound.ENTITY_PARROT_IMITATE_SLIME,
            Sound.ENTITY_PARROT_IMITATE_SPIDER,Sound.ENTITY_PARROT_IMITATE_STRAY,Sound.ENTITY_PARROT_IMITATE_VEX,
            Sound.ENTITY_PARROT_IMITATE_VINDICATION_ILLAGER,Sound.ENTITY_PARROT_IMITATE_WITCH,Sound.ENTITY_PARROT_IMITATE_WITHER,
            Sound.ENTITY_PARROT_IMITATE_WITHER_SKELETON,Sound.ENTITY_PARROT_IMITATE_WOLF,Sound.ENTITY_PARROT_IMITATE_ZOMBIE,
            Sound.ENTITY_PARROT_IMITATE_ZOMBIE_PIGMAN,Sound.ENTITY_PARROT_IMITATE_ZOMBIE_VILLAGER),
